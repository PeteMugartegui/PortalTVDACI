    ...
    <div class="container">
        ...
        <div class="row-fluid" id="primero">
                <div class="span12">
                        <nav id="barra">
                            <ul>
                                <li class="lista"><a href="acercade.php" class="active">Acerca de</a></li>
        ...
        <div class="row-fluid">
            <div class="span12" id="wrapper-acerca" >
                <div id="cuadro-acerca">
                    <p class="parrafo-acerca"  style="margin-top:50px;">La DES DACI se encuentra en transición hacia la modernidad y la excelencia, con plena conciencia del gran desafío, y las oportunidades que plantean los cambios sociales, politico y econmico en el mundo actual.</p>
                    <p class="parrafo-acerca" style="margin-top:50px;">Para fortalecer nuestro modelo educativo, basado en los principios de la UNESCO, Aprender a aprender, aprender a hacer...</p>
                </div>
