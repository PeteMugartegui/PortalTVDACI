...
<body>
    <div class="container">
                ...
                <div class="span12">
                        <nav id="barra">
                            <ul>
                                ...
                                <li class="lista"><a href="servicios.php" class="active">Servicios</a></li>
        ...
        <div class="row-fluid">
            <div class="span12" id="wrapper-serv" >
                <div id="cuadro-servicios">
                        <div class="span12">
                            <div style="width:100%; height:130px; background-color:#fff; border-bottom-style:solid; border-bottom-color:#FFC600; ">
                                <div class="span2">
                                    <img src="img/escuela.png" >
                                </div>
                                <div class="span10">
                                    <p style="margin-top:50px;" class="parrafo-gris">La UNACAR ofrece al estudiante un espacio virtual, para el aprendizaje significativo;<br> un campus virtual que tiene las facilidades y los servicios necesarios para el desarrollo profesional</p>
                                </div>
                            </div>  
                        </div>
                        <div class="row-fluid">
                            <div class="span12" style="width:100%; height:130px; background-color: #fff;">
                                <div class="span4" style="height:100%;">
                                    <div class="span6" style=" height:100%; border-bottom-style:solid; border-bottom-color:#FFC600;"><img src="img/escuela2.png" ></div>
                                    <div class="span6" style=" height:100%; border-right-style:solid; border-right-color:#FFC600;">
                                        <p class="parrafo-gris">Aulas equipadas con tecnologìa de apoyo al proceso de enseñanza/aprendizaje</p>
                                    </div>
                                </div>
                                <div class="span4" style="height:100%;">
                                    <div class="span6" style="height:100%;">
                                        <img src="img/edificio7.png" style="height:150px; width:150px;">
                                    </div>
                                    <div class="span6" style="height:100%; border-bottom-style:solid; border-bottom-color:#FFC600; border-right-style:solid; border-right-color:#FFC600;">
                                        <p class="parrafo-gris">Biblioteca Virtual</p>
                                        <p class="parrafo-gris">Equipada con salas de estudio individual, aprendizaje colaborativo, </p>
                                    </div>
                                </div>
                                <div class="span4" style="height:100%; margin:0;">
                                    <div class="span6" style="height:100%; margin:0; border-bottom-style:solid; border-bottom-color:#FFC600;"><img src="img/edificio2.png"  style="height:90px; "></div>
                                    <div class="span6" style="height:100%;">
                                    <p class="parrafo-gris">Dependencias, edificios administrativos y de servicios.</p> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row-fluid">
                            <div class="span12" style="width:100%; height:130px; background-color: #fff;">
                                <div class="span4" styles="height:100%;">
                                    <div class="span6"styles="height:100%;"><img src="img/edificio3.png" style="height:90px;"></div>
                                    <div class="span6" styles="height:100%;">
                                        <p class="parrafo-gris">Centro de información virtual y Radio delfín.</p>
                                    </div>
                                </div>
                                <div class="span4" styles="height:100%;">
                                    <div class="span6" styles="height:100%;"><img src="img/edificio6.png" style="height:90px;" ></div>
                                    <div class="span6" styles="height:100%;">
                                        <p class="parrafo-gris">Tienda virtual Universitaria.</p>
                                    </div>
                                </div>
                                <div class="span4" styles="height:100%;">
                                    <div class="span6" styles="height:100%;"><img src="img/edificio.png" ></div>
                                    <div class="span6" styles="height:100%;">
                                        <p class="parrafo-gris">Espacios complementarios virtuales: Difusión Cultural, Auditorio Universitario, Museo de Arte.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
