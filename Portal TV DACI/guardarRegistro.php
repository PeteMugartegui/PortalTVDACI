<?php
    ...
    $str_matricula =trim($_POST['tx_matricula']);
    ...
    if( estaEnBlanco($str_matricula) )
        $mensajesAll .= "<li>Por favor, escriba su Matricula.</li>";
    if( validaTamanio($str_matricula,6) )
        $mensajesAll .= "<li>Su Matricula como minimo debe tener 6 caracteres.</li>";
    ...
    <form id="frm_error"   name="frm_error" method="post" action="registro.php">
        ...
        <input type="hidden" name="str_matricula" value='<?php echo $str_matricula ?>' />
