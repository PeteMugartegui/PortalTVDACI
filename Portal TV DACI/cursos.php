...
<body>
    <div class="container">
                ...
                <div class="span12">
                        <nav id="barra">
                            <ul>
                                ...
                                <li class="lista"><a href="cursos.php" class="active">Cursos</a></li>
        ...
        <div class="row-fluid">
            <div class="span12" id="wrapper-acerca" >
                    ...
                    <div class="container">
                        <div class="span12">
                            <div style="width:100%; height:695px; background-color:rgba(12,126,207,0.4); border-style:solid; border-color:#FFC600; ">
                                <h4 class="titulo" style="margin-top:50px; margin-bottom:50px;">Talleres y Materias inscritas en el AVA.</h4>
                                <div class="row-fuid">
                                    <div class="span12">
                                        <div class="span4">
                                            <div class="cuadros-cuad">
                                                <h4 class="titulo" style="margin-top:50px; margin-bottom:50px;">Talleres</h4>
                                               <?php
...
$tabla = mysql_query("SELECT id_taller, tx_ntaller FROM tbl_taller ORDER BY id_taller ASC"); // selecciono todos los registros de la tabla usuarios, ordenado por nombre

while ($registro = mysql_fetch_array($tabla)) { // comienza un bucle que leera todos los registros y ejecutara las ordenes que siguen

    echo 'numero: ' . $registro['id_taller'] . ' '; // imprime el texto, el valor del numero del campo id y hace un salto de línea

    echo 'nombre del taller: ' . $registro['tx_ntaller'] . ' '; // imprime el nombre
...
$tabla = mysql_query("SELECT id_materia, tx_nmateria FROM tbl_materia ORDER BY id_materia ASC"); // selecciono todos los registros de la tabla usuarios, ordenado por nombre

while ($registro = mysql_fetch_array($tabla)) { // comienza un bucle que leera todos los registros y ejecutara las ordenes que siguen

    echo 'numero: ' . $registro['id_materia'] . ' '; // imprime el texto, el valor del numero del campo id y hace un salto de línea

    echo 'nombre de la materia: ' . $registro['tx_nmateria'] . ' '; // imprime el nombre
...
?>
                                        ...
                                        <div class="span4">
                                            <div class="cuadros-cuad">
                                                <h4 class="titulo" style="margin-top:50px; margin-bottom:50px;">Nuevos Cursos</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
