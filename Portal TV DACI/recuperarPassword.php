...
<tr>
    <td colspan="2" align="center"><h3><b><font color="white">Recuperar Password</font></b></h3></td>
</tr>
...
"*","]","[","_",":",";","+");
    ...
    // Le  Envio  por correo electronico  su nuevo password 
     ...
     $nomAdmin          = 'carlos cabrera';       //Quien envia
     $mailAdmin         = 'sintitulo.ros@gmail.com';   //Mail de quien envia
...
<tr>
    <td colspan="2"><font color="white">Escriba su correo electronico con el que se ha registrado, 
        se le enviara un nuevo password a su correo electronico:</font><br /><br /> 
    </td>
</tr>
 
<tr>
    <td><font color="white">Correo electronico:</font></td>
    <td>
        <input type="text" name="correo" id="correo"  maxlength="50" />
    </td>
</tr>
<tr>
    <td><font color="white">Confirme Correo electronico:</font></td>
    <td>
