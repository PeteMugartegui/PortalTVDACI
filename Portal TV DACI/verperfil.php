...
<?php
    ...
    $sql = "SELECT  tx_nombre,tx_apellidoPaterno,tx_TipoUsuario,id_usuario,tx_apellidoMaterno,tx_matricula,tx_correo,tx_username,tx_password,tx_dependencia,tx_peducativo,tx_ciclo,tx_habilidades,tx_hdesarrollar,tx_pasatiempos,tx_pfuturos,tx_cursos,dt_registro
            FROM tbl_users
    ...
    $numerousuario = $fila['id_usuario'];
    $apellidoP = $fila['tx_apellidoPaterno'];
    $apellidoM = $fila['tx_apellidoMaterno'];
    $correo = $fila['tx_correo'];
    $password = $fila['tx_password'];
    $tipousuario = $fila['tx_TipoUsuario'];
    $dtregistro = $fila['dt_registro'];
    $nombreC = $fila['tx_nombre']." ".$fila['tx_apellidoPaterno']." ".$fila['tx_apellidoMaterno'];
    $matricula = $fila['tx_matricula'];
    $dependencia=$fila['tx_dependencia'];
    $peducativo=$fila['tx_peducativo'];
    $ciclo=$fila['tx_ciclo'];
    $habilidades=$fila['tx_habilidades'];
    $hdesarrollar=$fila['tx_hdesarrollar'];
    $pasatiempos=$fila['tx_pasatiempos'];
    $cursos=$fila['tx_cursos'];
    $pfuturos=$fila['tx_pfuturos'];
...
<div class="container">
    <div class="row-fluid">
      <div class="pan12">
          <div id="barra-blanca">
            ...
            <div class="span6">
            <p   text align="right">Bienvenido <b><?php echo $nombreUsuario ?></b><a href="cerrarSesion.php">Cerrar sesi&oacute;n</a> 
</p>
            </div>
          </div>
        </div>
        ...
        <div class="span12">
            <nav id="barra">
              <ul>
                ...
                <li class="lista"><a href="verperfil.php" class="active">Perfil</a></li>
                <li class="lista"><a href="cursos.php">Cursos</a></li>
                <li class="lista"><a href="campus.html">Campus</a></li>
    ...
    <div class="row-fluid">
      <div class="span12" id="wrapper-perfil" >
        <div id="cuadro-servicios">
          <div class="container">
            <div class="span12">
              <div style="width:100%; height:695px; background-color:rgba(12,126,207,0.4); border-style:solid; border-color:#FFC600; ">
                <div class="span6">
                  <img src="img/usuario.png" style="width:150px; height:150px; margin-top:200px; margin-left:200px;">
                   <h4 class="titulo"><b><?php echo $nombreUsuario ?></b></h4>
                </div>
                <div class="span6">
                  <div class="span6"> <!-- Datos del Usuario-->
                    <table border="0" style="margin-top:50px;">
                      <tr>
                        <td><p class="parrafo-negro">Nombre</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $nombreC ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Matricula</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $matricula ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Dependencia</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $dependencia ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Programa Educativo</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $peducativo ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Curso</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $cursos ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Ciclo Escolar</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $ciclo ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Correo Electronico</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $correo ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Planes Futuros</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $pfuturos ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Habilidades</p></td>
                         <td><p class="parrafo-amarillo"><?php echo $habilidades ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Habilidades a Desarrollar</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $hdesarrollar ?></p></td>
                      </tr>
                      <tr>
                        <td><p class="parrafo-negro">Pasatiempos</p></td>
                        <td><p class="parrafo-amarillo"><?php echo $pasatiempos ?></p></td>
                      </tr>
                    </table>
        ...
        <img src="img/divisorcti.png" style="width:100%;">
      </div>
    </div>
